...
export default function AlienSign(props) {
  ...
  return (
    ...
    // xmlspace="preserve"
    <svg version="1.1" id="alien" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 239 386.6" className={alienClass}>
      <g id="alien-body">
        <path
          className="st0"
     ...
     c-4.8-5.5-15.4-3.9-23.8,3.4c-6,5.3-9.2,12.1-8.7,17.6C183.1,80.7,186.1,75,191.3,70.5z"
        />
        <ellipse transform="matrix(0.3348 -0.9423 0.9423 0.3348 42.7204 162.3934)" className="st3" cx="136.4" cy="50.9" rx="4.2" ry="1.8" />
        <ellipse transform="matrix(0.3348 -0.9423 0.9423 0.3348 41.6856 171.7553)" className="st3" cx="142.5" cy="56.4" rx="3" ry="1.4" />
        <ellipse transform="matrix(0.9423 -0.3348 0.3348 0.9423 -6.7321 73.7608)" className="st3" cx="210.6" cy="56.4" rx="1.4" ry="3.1" />
        <path className="st4" d="M185.5,65.9l-8.8,9.1l-9.1-8.8C173.7,69.9,179.6,69.6,185.5,65.9z" />
        <path className="st5" d="M182.9,121.5c-5.2,1.1-12.7,0-12.7,0l3.5-2.4l2.8,0.8l3-0.8L182.9,121.5z" />

        <ellipse transform="matrix(0.2331 -0.9725 0.9725 0.2331 33.5828 247.0292)" className="st5" cx="173.4" cy="102.2" rx="2.6" ry="1.6" />

        <ellipse transform="matrix(0.9725 -0.2331 0.2331 0.9725 -18.8634 44.8725)" className="st5" cx="180.4" cy="102.2" rx="1.6" ry="2.6" />
        <path
          className="st6"
     ...
     c4.5-4.5,7.4-10.4,8.2-16.8C206.5,266.2,203.8,271.4,199.8,275.4z"
        />
        <path className="st6" d="M203.4,204c1.1-6.5,2.6-12.9,4.1-19.2c0.1-0.5,0.2-1.1,0.2-1.7C206.2,190,204.5,196.9,203.4,204z" />
        <path
          className="st6"
     ...
     l0,0C197.5,161.8,197.2,162.1,196.8,162.1C196.8,162.1,196.8,162.1,196.8,162.1z"
        />
        <path className="st7" d="M171.2,150.7c0,0,1.8,9.2,4.9,9.8c0,0,3.1,0.8,5.1-9.6c0,0-0.8,11.4-4.9,12.3S171.2,150.7,171.2,150.7z" />
        <path
          className="st7"
     ...
     L180.4,279.1z"
        />
        <ellipse className="st6" cx="177.4" cy="252.8" rx="1.1" ry="2.4" />
        <path
          className="st7"
     ...
     c-1.4,5.8-1.6,11.8-0.6,17.7l15.9,96.6C162.9,385.6,163.8,386.3,164.8,386.5z"
        />
        <ellipse transform="matrix(0.9423 -0.3348 0.3348 0.9423 -4.0435 74.6672)" className="st3" cx="214.6" cy="49.1" rx="1.8" ry="4.2" />
      </g>
      <g>
        <g id="alien-sign">
          <path
